...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBNodeAgentEgressSpec) DeepCopyInto(out *LBNodeAgentEgressSpec) {
	*out = *in
	if in.DontNAT != nil {
		in, out := &in.DontNAT, &out.DontNAT
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBNodeAgentEgressSpec.
func (in *LBNodeAgentEgressSpec) DeepCopy() *LBNodeAgentEgressSpec {
	if in == nil {
		return nil
	}
	out := new(LBNodeAgentEgressSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceGroupAddressPool.
func (in *ServiceGroupAddressPool) DeepCopy() *ServiceGroupAddressPool {
	if in == nil {
		return nil
	}
...
func (in *ServiceGroupLocalSpec) DeepCopyInto(out *ServiceGroupLocalSpec) {
	*out = *in
	...
	if in.V4Pools != nil {
		...
		*out = make([]*ServiceGroupAddressPool, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ServiceGroupAddressPool)
